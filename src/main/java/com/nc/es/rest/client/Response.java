...
/**
 * Holds an elasticsearch response. It wraps the {@link HttpResponse} returned and associates it
 * with its corresponding {@link RequestLine} and {@link HttpHost}.
 */
public class Response {
	...
	/**
	 * Returns the value of the first header with a specified name of this message. If there is more
	 * than one matching header in the message the first element is returned. If there is no
