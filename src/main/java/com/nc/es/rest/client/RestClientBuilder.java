...
/**
 * Helps creating a new {@link RestClient}. Allows to set the most common http client configuration
 * options when internally creating the underlying
 * {@link org.apache.http.nio.client.HttpAsyncClient}. Also allows to provide an externally created
...
public final class RestClientBuilder {
	 ...
	 *             if {@code hosts} or any host is {@code null}.
	 * @throws IllegalArgumentException
	 *             if {@code hosts} is empty.
	 */
	 ...
	 *
	 * @throws NullPointerException
	 *             if {@code defaultHeaders} or any header is {@code null}.
	 */
	 ...
	 *
	 * @throws NullPointerException
	 *             if {@code failureListener} is {@code null}.
	 */
	...
	/**
	 * Sets the maximum timeout (in milliseconds) to honour in case of multiple retries of the same
	 * request. {@link #DEFAULT_MAX_RETRY_TIMEOUT_MILLIS} if not specified.
	 *
	 * @throws IllegalArgumentException
	 *             if {@code maxRetryTimeoutMillis} is not greater than 0
	 */
	 ...
	 *
	 * @throws NullPointerException
	 *             if {@code httpClientConfigCallback} is {@code null}.
	 */
	 ...
	 *
	 * @throws NullPointerException
	 *             if {@code requestConfigCallback} is {@code null}.
	 */
	 ...
	 * <p>
	 * For example, if this is set to "/my/path", then any client request will become
	 * <code>"/my/path/" + endpoint</code>.
	 * <p>
	 * In essence, every request's {@code endpoint} is prefixed by this {@code pathPrefix}. The path
	 * prefix is useful for when Elasticsearch is behind a proxy that provides a base path; it is
	 * not intended for other purposes and it should not be supplied in other scenarios.
	 *
	 * @throws NullPointerException
	 *             if {@code pathPrefix} is {@code null}.
	 * @throws IllegalArgumentException
	 *             if {@code pathPrefix} is empty, only '/', or ends with more than one '/'.
	 */
	...
	public interface RequestConfigCallback {
		/**
		 * Allows to customize the {@link RequestConfig} that will be used with each request. It is
		 * common to customize the different timeout values through this method without losing any
		 * other useful default value that the {@link RestClientBuilder} internally sets.
		 */
		RequestConfig.Builder customizeRequestConfig(RequestConfig.Builder requestConfigBuilder);
	}

	/**
	 * Callback used to customize the {@link CloseableHttpClient} instance used by a
	 * {@link RestClient} instance. Allows to customize default {@link RequestConfig} being set to
	 * the client and any parameter that can be set through {@link HttpClientBuilder}
	 */
	public interface HttpClientConfigCallback {
		/**
		 * Allows to customize the {@link CloseableHttpAsyncClient} being created and used by the
		 * {@link RestClient}. Commonly used to customize the default
		 * {@link org.apache.http.client.CredentialsProvider} for authentication or the
		 * {@link SchemeIOSessionStrategy} for communication through ssl without losing any other
		 * useful default value that the {@link RestClientBuilder} internally sets, like connection
		 * pooling.
		 */
