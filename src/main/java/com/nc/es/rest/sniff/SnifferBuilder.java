...
public final class SnifferBuilder {
	...
	/**
	 * Creates a new builder instance by providing the {@link RestClient} that will be used to
	...
	/**
	 * Sets the interval between consecutive ordinary sniff executions in milliseconds. Will be
	 * honoured when sniffOnFailure is disabled or when there are no failures between consecutive
	 * sniff executions.
	 * 
	...
	/**
	 * Sets the {@link HostsSniffer} to be used to read hosts. A default instance of
	 * {@link ElasticsearchHostsSniffer} is created when not provided. This method can be used to
	 * change the configuration of the {@link ElasticsearchHostsSniffer}, or to provide a different
	 * implementation (e.g. in case hosts need to taken from a different source).
	 */
